...
function readSchemeType(value: unknown): SchemeType | null {
  return value === 'deepl' || value === 'google' || value === 'googleCloud' || value === 'baidu' || value === 'baiduAi' || value === 'baiduWeb' || value === 'bing' || value === 'tencent' || value === 'youdao' || value === 'mymemory' || value === 'yandex' || value === 'volcengine' || value === 'ai' ? value : null
}
